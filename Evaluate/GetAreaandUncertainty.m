clear; close all; clc;
Time = datetime('2004-01-01') : datetime('2022-12-31');
MMDD = str2double(string(datestr(Time, 'mmdd')));
Time = Time(MMDD > 400 & MMDD < 1100);
YearLength = 214;
SavePath = 'C:\Users\13098\Documents\冰间湖识别\DataTrans\SensitiveAanlysis\';

%% PSSM
if 1
%%
Path = 'G:\AAPSResults\AMSR36_PSSM\AAPS_s12500_AMSR_PSSM_';
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM70\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM75\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM80\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM_10d\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM_20d\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM_12.5km_14d_DailyTracem\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM_12.5km_14d_DailyTracep\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM_12.5km_14d_YearlyTracem\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM_12.5km_14d_YearlyTracep\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM_NoFastIce\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
%%
Path = 'G:\AAPSResults\AMSR36_PSSM_25km\AAPS_s12500_AMSR_PSSM_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 25 * 25;
...
%%
Path = 'G:\AAPSResults\AMSR_SIC70_6.25km_20d\AAPS_s3125_AMSR_SIC_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 6.25 * 6.25;
...
%%
Path = 'G:\AAPSResults\AMSR_SIC50_6.25km_20d\AAPS_s3125_AMSR_SIC_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 6.25 * 6.25;
...
%%
Path = 'G:\AAPSResults\AMSR_SIC80_6.25km_20d\AAPS_s3125_AMSR_SIC_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 6.25 * 6.25;
...
%%
Path = 'G:\AAPSResults\AMSR_SIC60_6.25km_10d\AAPS_s3125_AMSR_SIC_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 6.25 * 6.25;
...
%%
Path = 'G:\AAPSResults\AMSR_SIC60_6.25km_14d\AAPS_s3125_AMSR_SIC_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 6.25 * 6.25;
...
%%
Path = 'G:\AAPSResults\AMSR_SIC60_6.25km_20d_DailyTrace-0.1\AAPS_s3125_AMSR_SIC_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 6.25 * 6.25;
...
%%
Path = 'G:\AAPSResults\AMSR_SIC60_6.25km_20d_YearlyTrace-0.1\AAPS_s3125_AMSR_SIC_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 6.25 * 6.25;
...
%%
Path = 'G:\AAPSResults\AMSR_SIC60_6.25km_20d_NoFastIce\AAPS_s3125_AMSR_SIC_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 6.25 * 6.25;
...
%%
Path = 'G:\AAPSResults\AMSR_SIC60_12.5km_20d\AAPS_s3125_AMSR_SIC_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 12.5 * 12.5;
...
save([SavePath, 'SIC_12.5km_60_20d.mat'], ...
   'Area', 'Area_U', 'IDs_d', 'IDs_y', 'IDs');
%%
Path = 'G:\AAPSResults\AMSR_SIC60_25km_20d\AAPS_s3125_AMSR_SIC_';
[Area, IDs_d, IDs_y, IDs] = GetAreaNum(Time, Path, YearLength);
Area_U = bootstrp(length(Area), @mean, Area);
Area_U = [prctile(Area_U, 2.5), prctile(Area_U, 97.5)];
Area = Area * 25 * 25;
...
for i = 1 : length(Time)
    ...
    try
        PolynyaMap = ncread([Path, datestr(Time(i), 'yyyymmdd'), '_v0.4.nc'], 'PolynyaIDMap');
    catch
        continue
    end
    ...
    PolynyaIDs = ncread([Path, datestr(Time(i), 'yyyymmdd'), '_v0.4.nc'], 'PolynyaIDs');
    CoastalFlag = ncread([Path, datestr(Time(i), 'yyyymmdd'), '_v0.4.nc'], 'CoastalPolynyaFlag');
