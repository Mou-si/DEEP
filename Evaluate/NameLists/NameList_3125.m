...
In.SICFile.Name1 = ...%     {'asi-AMSR2-s3125-'};
    {'asi-s3125-', 'asi-s3125-', 'asi-AMSR2-s3125-'};
...
% read the Lon & Lat
In.SICLon = hdfread(...
    [In.SICFile.Dir, '\LongitudeLatitudeGrid-s3125-Antarctic.hdf'], 'Longitudes');
In.SICLat = hdfread(...
    [In.SICFile.Dir, '\LongitudeLatitudeGrid-s3125-Antarctic.hdf'], 'Latitudes');
% In.SICLon = load('G:\Antaratica_ASI_SIC_6250\LonLat_25000.mat');
% In.SICLat = In.SICLon.Lat;
% In.SICLon = In.SICLon.Lon;
% read land mask
In.SICFile.LandMask = ncread([In.SICFile.Dir, '\LandMaskAMSR3125.nc'], 'LandMask');
% set the resolution
In.Resolution = 3.125;

%% Land Fast Ice
In.FastIceFlag = FastIceParameter_3125km;
...
%% SaveResults
In.Save.Path = ...
    'G:\DEEP-AAShare\SIC60_3.125km_20d';
In.Save.FileName1 = ...
    'DEEP_s3125_AMSR_SIC_';
In.Save.FileName2 = ...
    '_v1.0.nc';
